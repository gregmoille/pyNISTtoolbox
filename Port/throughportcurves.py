...
def CreateThroughPortCurveS(fid, param, ncell, cnt_out):
    ...
    if resist == 'positive':
        ...
        name_out.append(Name + 'InSin' + 'Cell' +
                        str(ncell) + '_' + str(cnt_out))
        fid.write('<' + Name + 'InSin' + 'Cell' +
                  str(ncell) + '_' + str(cnt_out) + ' struct>\n')
        fid.write('\t<{} {} '.format(x2_in_wg, y_thrgh) +
                                      '{} {} '.format(xin_c, yin_c) +
                                      '{} {} '.format(W, 0) +
                                      'sBend>\n')
        ...
        # fid.write(str(layer) + ' layer\n')
        # name_out.append(Name + 'InSin2' + 'Cell' +
        #                 str(ncell) + '_' + str(cnt_out))
        # fid.write('<' + Name + 'InSin2' + 'Cell' +
        #           str(ncell) + '_' + str(cnt_out) + ' struct>\n')
        # fid.write('\t<{} {} '.format(xin_c, yin_c) +
        #                               '{} {} '.format(xR,y_thrgh ) +
        #                               '{} {} '.format(W, 0) +
        #                               'sBend>\n')


        name_out.append(Name + 'InWgC1_' + 'Cell' +
                        str(ncell)+ '_' + str(cnt_out))
        fid.write(str(layerWg) + ' layer\n')
        fid.write('<' + Name + 'InWgC1_' + 'Cell' +
                  str(ncell) + '_' + str(cnt_out) + ' struct>\n')
        fid.write('\t<{} {} '.format(xin_c, yin_c) +
